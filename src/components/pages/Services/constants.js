...
export const SERVICES_HERO_DATA = {
  title: 'Complete Technical Services. One Trusted UAE Team.',
  description:
...
export const ALL_SERVICES_LIST = [
  ...
  // Row 5
  {
    ...
    imageKey: 'interlockInstallation',
  ...
  },
  {
    ...
    imageKey: 'fixturesRepairing',
    href: '/services/fixtures-repairing',
  },
  // Row 7
  {
    ...
    imageKey: 'sanitaryInstallation',
    href: '/services/sanitary-installation',
  },
  {
    ...
    imageKey: 'ventilationsInstallation',
